...
public:
    static CompactionProfile* create_global_instance() { return new CompactionProfile(); }
    static CompactionProfile* instance() {
        return ExecEnv::GetInstance()->get_compaction_profile();
    }
    CompactionProfile();
